...
// 环境顺序
let envOrders = ['development', 'production'];

let runAppVariableName = '@@__reactRunApplicationName__@@';
...
function AppContext() {
  // 初始化环境
  let env = this.env = process.env.NODE_ENV || 'development';
 ...
 */
AppContext.prototype.valueOf = function (...values) {
