Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src\\Components\\Modal\\Modal.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();
...
var modalStyle={backgroundColor:transparent?'transparent':'white',backfaceVisibility:'hidden',perspective:1000};
...
return(
_react2.default.createElement(_reactNativeWeb.Animated.View,{style:[styles.modal,this.state.initStyle],onStartShouldSetResponder:this._shouldSetResponder.bind(this),__source:{fileName:_jsxFileName,lineNumber:230}},
this.props.children));
