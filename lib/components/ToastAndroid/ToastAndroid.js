...
return(
_react2.default.createElement(_reactNativeWeb.Animated.Text,{style:{
...
setTimeout(function(){
var state={remove:false,message:message,showing:true,scale:AnimateValue(1.185),toScale:1};
